function [mInfo_tune, mNSS_tune, opt] = calcMain(opt_set, EXPALLFixations, ALLFeatures, faceFeatures)
...
savefile = sprintf('../Output/storage/EXP_%s_angle%dregion%d_%s.mat', opt.time_stamp, opt.enable_angle, opt.n_region, time_stamp);
