%% Gernerate learning and testing samples
function [sample_saccade, testingsamles] = getIndiviSamples(EXPALLFixations, opt, indiviNum)
...
for imgidx=1:400
    ...
    if(c_sample_saccade < opt.sampleNumber && rand>.5)
        training_flag = 1;
    end
