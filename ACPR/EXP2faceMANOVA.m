...
for subjecti = 1:15
        for i = 1:subsetSize
            ...
            for regioni = 1:6
                rangeL = regioni*10;
                rangeR = regioni*10;
                tmp(i,regioni) = EXP_INDV_REGION_NOANGLE_ms6{subjecti}.mInfo_tune{i}.weight(rangeL:rangeR);
