%% Hotelling T2 test for 15C2 combinations of pairs (Face 6 dimentional)
dMatrix = zeros(15,15);
pMatrix = zeros(15,15);
statsMat = cell(15,15);
left = zeros(10,6);
    ...
    for subjectRight = subjectLeft+1:15
        for i = 1:10
            ...
            for regioni = 1:6
                ...
                left(i,regioni) = EXP_INDV_REGION_NOANGLE_ms6{subjectLeft}.mInfo_tune{i}.weight(rangeL:rangeR);
                right(i,regioni) = EXP_INDV_REGION_NOANGLE_ms6{subjectRight}.mInfo_tune{i}.weight(rangeL:rangeR);
