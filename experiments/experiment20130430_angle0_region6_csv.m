...
for subjecti = 1:15
    outputcsv = sprintf('subject_20trail_%d.csv',subjecti);
    ...
    vals_tune = zeros(info.opt_base.n_trial, size(EXP_INDV_REGION_NOANGLE_ms6{subjecti}.mInfo_tune{1}.weight,1));
