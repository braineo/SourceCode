...
function  [mInfo_tune, mNSS_tune, opt] = calcMainPerSubject20130906(opt_set, EXPALLFixations, featureGBVS, faceFeatures, sampleinfo, sampleinfoStat,subjecti)
    ...
    triali = 1;
    shuffleOrder = randperm(400);
    for trainImageNum = opt.trainImageNum
        fprintf('Start Calculation on Subject#%d, train image number #%d...\n',subjecti, trainImageNum);
        trainImgIndex = shuffleOrder(1:trainImageNum);
        countNearAll = 0;
        countFarAll = 0;
