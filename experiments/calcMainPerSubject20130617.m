...
function  [mInfo_tune, mNSS_tune, opt] = calcMainPerSubject20130617(opt_set, EXPALLFixations, featureGBVS, faceFeatures, sampleinfo, sampleinfoStat,subjecti)
    ...
    for triali = 1:opt.n_trial;
        ...
        countNearAll = 0;
        countFarAll = 0;
        num_feat_A = 9; %total number of features, no face
        if(opt.enable_angle)
        ...
        %% picture 1:400 training set, picture 0 test set
        ...
        for imgIdx = imgUsed
            ...
            for i = posIdx
                ...
                singleFeature = [c1(singleSample(3),singleSample(2)) c2(singleSample(3),singleSample(2)) c3(singleSample(3),singleSample(2))...
                                 ...
                                 o1(singleSample(3),singleSample(2)) o2(singleSample(3),singleSample(2)) o3(singleSample(3),singleSample(2))];
                if(opt.enable_angle)
